...
const std::string BGLGUI::DEFAULT_UIPLATFORM =
#if defined(Q_OS_MAC)
        "macosx"
...
BGLGUI::BGLGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
...
#ifdef ENABLE_WALLET
    if(enableWallet) {
        connect(walletFrame, &WalletFrame::requestedSyncWarningInfo, this, &BGLGUI::showModalOverlay);
    }
#endif
...
void BGLGUI::createActions()
{
    ...
    connect(overviewAction, &QAction::triggered, this, &BGLGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(sendCoinsMenuAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsMenuAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &BGLGUI::gotoReceiveCoinsPage);
    connect(receiveCoinsMenuAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsMenuAction, &QAction::triggered, this, &BGLGUI::gotoReceiveCoinsPage);
    ...
    connect(toggleHideAction, &QAction::triggered, this, &BGLGUI::toggleHidden);
    connect(showHelpMessageAction, &QAction::triggered, this, &BGLGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &BGLGUI::showDebugWindow);
    ...
    connect(new QShortcut(QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_C), this), &QShortcut::activated, this, &BGLGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_D), this), &QShortcut::activated, this, &BGLGUI::showDebugWindow);
}
...
void BGLGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &BGLGUI::setCurrentWalletBySelectorIndex);
...
void BGLGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &BGLGUI::showProgress);
        ...
        if (optionsModel && trayIcon) {
            ...
            connect(optionsModel, &OptionsModel::showTrayIconChanged, this, &BGLGUI::setTrayIconVisible);
...
void BGLGUI::setWalletActionsEnabled(bool enabled)
{
...
void BGLGUI::createTrayIconMenu()
{
#ifndef Q_OS_MAC
    ...
    connect(trayIcon, &QSystemTrayIcon::activated, this, &BGLGUI::trayIconActivated);
#else
    // Note: On macOS, the Dock icon is used to provide the tray's functionality.
    MacDockIconHandler *dockIconHandler = MacDockIconHandler::instance();
    connect(dockIconHandler, &MacDockIconHandler::dockIconClicked, this, &BGLGUI::macosDockIconActivated);
...
#ifndef Q_OS_MAC
void BGLGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
#else
void BGLGUI::macosDockIconActivated()
{
    show();
    activateWindow();
}
...
void BGLGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void BGLGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void BGLGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void BGLGUI::showDebugWindowActivateConsole()
{
...
void BGLGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void BGLGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void BGLGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void BGLGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void BGLGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void BGLGUI::gotoVerifyMessageTab(QString addr)
{
...
void BGLGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to BGL network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
void BGLGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void BGLGUI::setNetworkActive(bool networkActive)
{
    updateNetworkState();
}

void BGLGUI::updateHeadersSyncProgressLabel()
{
...
void BGLGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
...
void BGLGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void BGLGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &BGLGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &BGLGUI::show);
                e->ignore();
            }
        }
    }
...
void BGLGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MAC // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void BGLGUI::showEvent(QShowEvent *event)
{
...
void BGLGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    ...
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(BGLUnits::formatWithUnit(unit, amount, true));
...
void BGLGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void BGLGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool BGLGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool BGLGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void BGLGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void BGLGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void BGLGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void BGLGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void BGLGUI::detectShutdown()
{
...
void BGLGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void BGLGUI::setTrayIconVisible(bool show_tray_con)
{
    if (trayIcon) {
...
void BGLGUI::subscribeToCoreSignals()
{
...
void BGLGUI::unsubscribeFromCoreSignals()
{
...
bool BGLGUI::isPrivacyModeActivated() const
{
