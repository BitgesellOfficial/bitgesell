...
public:
    ...
    explicit BGLGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BGLGUI();
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BGLUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BGL Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BGLUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BGL_QT_BGLGUI_H
