    ...
    platformStyle(_platformStyle)
{
    ...
    // normal BGL address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying BGL address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BGLAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
