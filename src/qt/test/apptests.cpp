...
//! Entry point for BGLApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BGLApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BGLGUI tests.
void AppTests::guiTests(BGLGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BGLGUI::consoleShown, this, &AppTests::consoleTests);
