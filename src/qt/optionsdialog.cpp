      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->BGLAtStartup->setToolTip(ui->BGLAtStartup->toolTip().arg(CLIENT_NAME));
    ui->BGLAtStartup->setText(ui->BGLAtStartup->text().arg(CLIENT_NAME));

    ui->openBGLConfButton->setToolTip(ui->openBGLConfButton->toolTip().arg(CLIENT_NAME));
