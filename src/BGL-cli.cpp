...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs) || gArgs.GetBoolArg("-version", false)) {
        ...
        if (gArgs.GetBoolArg("-version", false)) {
            ...
            strUsage += "\n"
                "The BGL-cli utility provides a command line interface to interact with a " CLIENT_NAME " RPC server.\n"
                ...
                "\n"
                "Usage: BGL-cli [options] <command> [params]\n"
                "or:    BGL-cli [options] -named <command> [name=value]...\n"
                "or:    BGL-cli [options] help\n"
                "or:    BGL-cli [options] help <command>\n"
                "\n";
