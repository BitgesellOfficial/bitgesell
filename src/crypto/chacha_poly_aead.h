...
#ifndef BGL_CRYPTO_CHACHA_POLY_AEAD_H
#define BGL_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@BGL.
 *
 ...
 *
 * The chacha20-poly1305@BGL combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@BGL cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@BGL are relatively fast in
...
#endif // BGL_CRYPTO_CHACHA_POLY_AEAD_H
