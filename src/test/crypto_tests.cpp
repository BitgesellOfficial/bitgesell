...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As BGL relies on 80 byte header hashes, we want to have an example for that.",
               "d43da9cbad99510d2b09db6a840d2ae9bab4a517042a5383152ec0586e9e28bd");
...
{
    /* test chacha20poly1305@BGL AEAD */
