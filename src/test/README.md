...
Run `build/bin/test_BGL --list_content` for the full list of tests.
...
*** No errors detected
$ ls -l '/somewhere/mydatadir/test_common bitgesell/getarg_tests/doubledash/datadir'
total 8
