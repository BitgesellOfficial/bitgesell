...
generated pathname within `test_common_BGL Core/`, which in turn is within
...
Test directory (will not be deleted): "/somewhere/mydatadir/test_common_Bitgesell Core/getarg_tests/doubledash/datadir"
Running 1 test case...
