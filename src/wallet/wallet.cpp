...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const TxState& state, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose, bool rescanning_old_block)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/BitgesellOfficial/bitgesell/pull/13339
...
bool CWallet::LoadToWallet(const uint256& hash, const UpdateWalletTxFn& fill_wtx)
{
    ...
    // If wallet doesn't have a chain (e.g when using BGL-wallet tool),
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/BitgesellOfficial/bitgesell/pull/18600.
        ...
        //    https://github.com/BitgesellOfficial/bitgesell/pull/9371 and the prior sync
        ...
        // https://github.com/BitgesellOfficial/bitgesell-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
 ...
 * https://github.com/BitgesellOfficial/bitgesell/pull/1393.
 */
