    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getnewaddress",
                ...
                RPCResult{
            "\"address\"    (string) The new BGL address\n"
                },
                RPCExamples{
...
static UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The BGL address\n"
...
static UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid BGL address: ") + name_);
        }
        ...
        return NullUniValue;
            ...
            RPCHelpMan{"addmultisigaddress",
                ...
                "If 'label' is specified, assign address to that label.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of BGL addresses or hex-encoded public keys",
                        {
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "    \"address\":\"address\",    (string) The BGL address of the transaction.\n"
...
static UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "  {                           (json object)\n"
            "    \"involvesWatchonly\": xxx, (bool) Only returns true if imported addresses were involved in transaction.\n"
            "    \"address\" : \"str\",        (string) The BGL address of the transaction.\n"
...
static UniValue gettransaction(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "      {\n"
            "        \"involvesWatchonly\": xxx,         (bool) Only returns true if imported addresses were involved in transaction.\n"
            "        \"address\" : \"address\",          (string) The BGL address involved in the transaction\n"
            "        \"category\" :                      (string) The transaction category.\n"
            "                     \"send\"                  Transactions sent.\n"
            "                     \"receive\"               Non-coinbase transactions received.\n"
            "                     \"generate\"              Coinbase transactions received with more than 100 confirmations.\n"
...
static UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "A json array of BGL addresses to filter",
                        {
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the BGL address\n"
...
static UniValue bumpfee(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp))
        return NullUniValue;
            ...
            "                         Must be at least 0.0001 BGL per kB higher than the current transaction fee rate.\n"},
...
UniValue getaddressinfo(const JSONRPCRequest& request)
{
    ...
    const std::string example_address = "\"bc1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl\"";
            ...
            RPCHelpMan{"getaddressinfo",
                ...
                RPCResult{
            "{\n"
            "  \"address\" : \"address\",              (string) The BGL address validated.\n"
