Bitgesell version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitcoin/files/Bitgesell/bitcoin-0.8.6/
...
- Fix Bitgesell startup crash when clicking dock icon on OSX 
