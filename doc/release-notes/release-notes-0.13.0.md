Bitgesell version 0.13.0 is now available from:
...
Various code modernizations have been done. The Bitgesell code base has
...
HD wallets are incompatible with older versions of Bitgesell.
...
proposed parameters, a future release of Bitgesell is expected that
...
The two phases are distinct in the Bitgesell GUI. During the first one,
...
- #8207 `f7a403b` Add a link to the Bitgesell-Core repository and website to the About Dialog (MarcoFalke)
...
- #8164 `0f24eaf` [Bitgesell-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
