Bitgesell version 0.16.0 is now available from:
...
Bitgesell now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile Bitgesell is now 4.8. No effort will be
