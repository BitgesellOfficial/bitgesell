Bitgesell version 0.11.0 is now available from:
...
Block pruning allows Bitgesell to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Bitgesell will 
...
- #6116 `30dc3c1` [OSX] rename Bitgesell.app to Bitgesell-Core.app
