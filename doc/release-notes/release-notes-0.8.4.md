Bitgesell version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Bitgesell/bitcoin-0.8.4/
...
code, causing the Bitgesell or bitcoind process to crash.
...
their own version of Bitgesell against Boost versions 1.50-1.52.
