Bitgesell version 0.17.0 is now available from:
...
Bitgesell is extensively tested on multiple operating systems using
...
BIP 174 Partially Signed Bitgesell Transactions support
-----------------------------------------------------

[BIP 174 PSBT](https://github.com/bitcoin/bips/blob/master/bip-0174.mediawiki) is an interchange format for Bitgesell transactions that are not fully signed
...
Overall, the construction of a fully signed Bitgesell transaction goes through the
following steps:
...
- An **Extractor** produces a valid Bitgesell transaction (in network format)
