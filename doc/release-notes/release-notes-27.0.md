Bitgesell version 27.0 is now available from:
...
using the Linux Kernel 3.17+, macOS 11.0+, and Windows 7 and newer. Bitgesell
...
- A C++20 capable compiler is now required to build Bitgesell. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Bitgesell would
