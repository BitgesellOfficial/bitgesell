Bitgesell version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Bitgesell/bitcoin-0.5.4/
...
Fix Bitgesell notifications under Growl 1.3.
Increase required age of Bitgesell's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Bitgesell over it. (Windows)
