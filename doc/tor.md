...
BGL Core automatically creates a hidden service to listen on. This will positively
affect the number of available .onion nodes.

This new feature is enabled by default if BGL Core is listening (`-listen`), and
...
which has the appropriate permissions. Before starting BGLd you will need to re-login
