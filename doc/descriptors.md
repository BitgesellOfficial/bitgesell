# Support for Output Descriptors in BGL Core

Since BGL Core v0.17, there is support for Output Descriptors. This is a
...
- P2SH addresses (base58, of the form `3...` for mainnet or `2...` for testnet, defined in [BIP 13](https://github.com/BGL/bips/blob/master/bip-0013.mediawiki)).
- Segwit addresses (bech32, of the form `bc1...` for mainnet or `tb1...` for testnet, defined in [BIP 173](https://github.com/BGL/bips/blob/master/bip-0173.mediawiki)).
...
on BGL's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
the entire path from the master down. [BIP174](https://github.com/BGL/bips/blob/master/bip-0174.mediawiki) standardizes this by
...
existing BGL Core wallets, a convenience function `combo` is
...
All RPCs in BGL Core will include the checksum in their output. Only
