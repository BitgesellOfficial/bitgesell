...
Every single pull request submitted against the BGL Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make BGL Core more robust.
...
Upstream Bitcoin Core participates in Google's [OSS-Fuzz](https://github.com/google/oss-fuzz/tree/master/projects/bitcoin-core)
...
because Bitcoin Core is a live P2P network, and not just standalone local software,
