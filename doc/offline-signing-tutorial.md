...
This tutorial will describe how to use two instances of Bitgesell Core, one online and one offline, to greatly increase security by not having private keys reside on a networked device.
...
## Overview
In this tutorial we have two hosts, both running Bitgesell Core.
