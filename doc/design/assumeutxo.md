...
Assumeutxo is a feature that allows fast bootstrapping of a validating BGLd
...
considered active. This is the "traditional" mode of operation for BGLd.
...
**Failure consideration:** if BGLd unexpectedly halts after `m_stop_use` is set on
...
### BGLd restarts sometime after snapshot validation has completed

When BGLd initializes again, what began as the snapshot chainstate is now
