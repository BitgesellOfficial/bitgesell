...
def b58encode(v):
    ...
    # BGL does a little leading-zero-compression:
...
if __name__ == '__main__':
    ...
    assert get_bcaddress_version('15VjRaDX9zpbA8LVnbrCAFzrVzN7ixHNsC') == 0 #Replacing is with == to remove syntactical error from this line of code
