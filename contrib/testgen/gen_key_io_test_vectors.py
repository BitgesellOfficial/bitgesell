...
SCRIPT_ADDRESS_TEST = 50
PUBKEY_ADDRESS_REGTEST = 34
SCRIPT_ADDRESS_REGTEST = 50
PRIVKEY = 128
PRIVKEY_TEST = 239
PRIVKEY_REGTEST = 239
...
bech32_templates = [
  ...
  ('bgl',   0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('bgl',   0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('bgl',   1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('bgl',   2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tbgl',  0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tbgl',  0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tbgl',  1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tbgl',  3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tbgl',  0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tbgl',  0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tbgl',  1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tbgl',  3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rbgl',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rbgl',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rbgl',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rbgl', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tbgl', 17, 32, Encoding.BECH32M, False, False, False),
  ('rbgl',  3,  1, Encoding.BECH32M, False, False, False),
  ('bgl',  15, 41, Encoding.BECH32M, False, False, False),
  ('tbgl',  0, 16, Encoding.BECH32,  False, False, False),
  ('rbgl',  0, 32, Encoding.BECH32,  True,  False, False),
  ('bgl',   0, 16, Encoding.BECH32,  True,  False, False),
  ('tbgl',  0, 32, Encoding.BECH32,  False, True,  False),
  ('rbgl',  0, 20, Encoding.BECH32,  False, False, True),
  ('bgl',   0, 20, Encoding.BECH32M, False, False, False),
  ('tbgl',  0, 32, Encoding.BECH32M, False, False, False),
  ('rbgl',  0, 20, Encoding.BECH32M, False, False, False),
  ('bgl',   1, 32, Encoding.BECH32,  False, False, False),
  ('tbgl',  2, 16, Encoding.BECH32,  False, False, False),
  ('rbgl', 16, 20, Encoding.BECH32,  False, False, False),
]
