...
Tracing (USDT) support for BGL Core on Linux. For more information on
USDT support in BGL Core see the [USDT documentation].
...
[BGL Core USDT documentation] on how to list available tracepoints in your
`BGLd` binary.

[BGL Core USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
In a different terminal, starting BGL Core in SigNet mode and with
re-indexing enabled.
