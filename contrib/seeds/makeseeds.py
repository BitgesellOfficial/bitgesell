...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of bitgesell node seed ip addresses.')
...
def main():
    ...
    print(f'{ip_stats(ips):s} Filter out hosts with multiple bitgesell ports', file=sys.stderr)
