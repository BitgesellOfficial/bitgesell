#!/usr/bin/env bash
# Copyright (c) 2021 The BGL Core developers
...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/BGL.conf}
...
## Generated by contrib/devtools/gen-BGL-conf.sh.
##
...
# parse the output from BGLd --help
