# Bootstrappable Bitgesell Core Builds

This directory contains the files necessary to perform bootstrappable Bitgesell
Core builds.
...
To build Bitgesell Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Bitgesell Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/bitgesell-detached-sigs> ./contrib/guix/guix-codesign
```
