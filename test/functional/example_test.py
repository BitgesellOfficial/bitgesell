...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BGLTestFramework
    pass


class ExampleTest(BGLTestFramework):
    # Each functional test is a subclass of the BGLTestFramework class.
    ...
    def custom_method(self):
        ...
        BGLTestFramework class so other tests can use it."""
