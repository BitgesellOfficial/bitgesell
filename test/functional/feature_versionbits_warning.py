...
class VersionBitsWarningTest(BGLTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because BGLd will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
