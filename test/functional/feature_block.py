...
class FullBlockTest(BGLTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure BGLd isn't accepting b26
        ...
        # Extend the b28 chain to make sure BGLd isn't accepting b28
        ...
        #
        # b40 creates 1072 tx's spending the 6-sigop P2SH outputs from b39 for a total of 6432 sigops.
        ...
        # BGLd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the BGL code has custom code which does so);
