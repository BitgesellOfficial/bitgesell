...
# TestP2PConn: A peer we use to send messages to BGLd, and store responses.
...
class CompactBlocksTest(BGLTestFramework):
    ...
    # This test actually causes BGLd to (reasonably!) disconnect us, so do this last.
