...
class TestFrameworkScript(unittest.TestCase):
    def test_segwit_encode_decode(self):
        ...
        # P2TR
        #test_python_bech32('rbgl1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqc8gma6')
