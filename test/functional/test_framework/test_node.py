...
class TestNode():
    ...
    def __init__(self, i, datadir, *, chain, rpchost, timewait, BGLd, BLG_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None):
        """
        Kwargs:
    ...
    def wait_for_rpc_connection(self):
        ...
        for _ in range(poll_per_s * self.rpc_timeout):
            ...
            try:
                ...
                pass
            except ValueError as e:  # cookie file not found and no rpcuser or rpcassword. BGLoind still starting
