...
class BGLChainstateTest(BGLTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_BGL_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing BGL-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    BGLChainstateTest(__file__).main()
