...
"""Verify that starting BGL with -h works as expected."""

from test_framework.test_framework import BGLTestFramework
from test_framework.util import assert_equal

class HelpTest(BGLTestFramework):
    ...
    def run_test(self):
        self.log.info("Start BGL with -h for help text")
        ...
        self.log.info("Start BGL with -version for version information")
        ...
        self.log.info("Start BGLd with -fakearg to make sure it does not start")
