...
class P2PPermissionsTests(BGLTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].BGLconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].BGLconf, 'w', encoding="utf8") as f:
            f.write(newText)
