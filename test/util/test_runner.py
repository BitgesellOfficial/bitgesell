...
def main():
    ...
    parser.add_argument(
        '--configfile',
        default=os.path.abspath(os.path.join(os.path.dirname(__file__), "../config.ini")),
        help="Test framework config file generated by configure.",
    )
    ...
    if not os.path.exists(configfile):
        parser.error(
            ...
            "Run ./configure first or pass --configfile."
        )
