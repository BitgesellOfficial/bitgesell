...
OutFile ..\BGL-0.1.8.0-win64-setup.exe
...
VIAddVersionKey ProductVersion "0.1.8"
VIAddVersionKey CompanyName "${COMPANY}"
VIAddVersionKey CompanyWebsite "${URL}"
VIAddVersionKey FileVersion "0.1.8"
...
Section -post SEC0001
    ...
    WriteRegStr HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)" DisplayVersion "0.1.8"
