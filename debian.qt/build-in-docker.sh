...
docker exec $container apt-get -y install build-essential apt-utils devscripts equivs sudo cmake ninja-build bison #dpkg-dev
docker exec $container apt-get -y install libqrencode-dev qttools5-dev qttools5-dev-tools libsqlite3-dev qtbase5-dev
...
docker cp ../bitgesell-qt_0.1.14.dsc $container:/root/repo/
docker cp ../bitgesell-qt_0.1.14.tar.xz $container:/root/repo/
...
# Копируем локальные debian/ файлы в исходник
docker cp ./debian $container:/home/user/build/bitgesell-qt-0.1.14/
docker exec -w /home/user/build/bitgesell-qt-0.1.14 $container sudo -u user debuild -b
docker cp $container:/home/user/build/bitgesell-qt_0.1.14_amd64.deb bitgesell-qt_0.1.14_amd64.deb
docker cp $container:/home/user/build/bitgesell-qt-dbg_0.1.14_amd64.deb bitgesell-qt-dbg_0.1.14_amd64.deb
