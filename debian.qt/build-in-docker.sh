...
docker cp ../bitgesell-qt_0.1.6.dsc $container:/root/repo/
docker cp ../bitgesell-qt_0.1.6.tar.xz $container:/root/repo/
...
docker exec -w /home/user/build/bitgesell-qt-0.1.6 $container sudo -u user debuild -b
docker cp $container:/home/user/build/bitgesell-qt_0.1.6_amd64.deb bitgesell-qt_0.1.6_amd64.deb
