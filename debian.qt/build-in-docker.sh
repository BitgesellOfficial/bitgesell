...
docker cp ../bitgesell-qt_0.1.8.dsc $container:/root/repo/
docker cp ../bitgesell-qt_0.1.8.tar.xz $container:/root/repo/
...
docker exec -w /home/user/build/bitgesell-qt-0.1.8 $container sudo -u user debuild -b
docker cp $container:/home/user/build/bitgesell-qt_0.1.8_amd64.deb bitgesell-qt_0.1.8_amd64.deb
