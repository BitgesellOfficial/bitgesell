...
list or participate in a weekly [BGL Core PR Review Club](https://BGLcore.reviews/) meeting.
...
the pull request affects. Valid areas as:
  ...
  - `test` for changes to the BGL unit tests or QA tests
...
[Translation Process](https://github.com/BGL/BGL/blob/master/doc/translation_process.md)
