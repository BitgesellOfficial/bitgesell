...
docker cp ../bitgesell_0.1.9.dsc $container:/root/repo/
docker cp ../bitgesell_0.1.9.tar.xz $container:/root/repo/
...
docker exec -w /home/user/build/bitgesell-0.1.9 $container sudo -u user debuild -b
docker cp $container:/home/user/build/bitgesell_0.1.9_amd64.deb bitgesell_0.1.9_amd64.deb
